...
export const Form = () => {
    ...
    const onSubmit = (data: RecipeForm) => {
        postDataToDB({title: data.title, ingredients: {ingredients: [data.ingredients]}, description: [data.description]})
    }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Controller name='description' control={control} defaultValue='' render={({field}) => (
                <label htmlFor='description'>
                    Description
                    <textarea id="description" cols={30} rows={10} {...field} ></textarea>        
                </label>
            )}
            />
